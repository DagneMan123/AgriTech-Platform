...
class StoreArticleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'article_content' => 'required|string|max:10000|min:100',
